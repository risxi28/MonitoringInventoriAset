  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        Selamat datang di Aplikasi MIA MIC, Barang yang berada di sini meruapakan aset milik MEDIA INFORMATIKA CENDEKIA 
    </div>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
          ...
          <div class="row">
            <div class="col-md-6">
                ...
                <tbody>
                    ...
                    <td><?php echo remove_junk(first_character($recent_sale['keterangan'])); ?></td>
                    </tr>
