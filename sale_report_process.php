...
<?php
  if(isset($_POST['submit'])){
    ...
    if(empty($errors)):
      ...
      $results      = find_issuing_by_dates($start_date,$end_date);
    else:
...
<body>
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class="text-right"><?php echo remove_junk($result['keterangan']);?></td>
  ...
  <?php
        ...
        $session->msg("d", "Sorry no Issuing has been found. ");
        redirect('sales_report.php', false);
     endif;
  ?>
</body>
