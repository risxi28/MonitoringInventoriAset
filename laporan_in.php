  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Laporan Receiving</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
             <div class="card">
             <a href="cetak_in.php" ><button type="button" class="btn btn-block bg-gradient-success"><i class="fa fa-print"></i>Cetak Receiving</button></a>
             </div>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
